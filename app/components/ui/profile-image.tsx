  ...
  return (
    <>
      <div className="relative w-full mb-20 h-40 md:h-56 lg:h-80 flex justify-center">
        <div
          onClick={() => setActivePhoto({ src: pathBanner, title: "Profile Banner" })}
          className="w-full h-full cursor-zoom-in"
          title="Click to enlarge banner"
        >
          <Banner path={pathBanner} />
        </div>

        <div
          onClick={() => setActivePhoto({ src: pathIcon, title: "Profile Picture" })}
          className="absolute left-1/2 -bottom-16 transform -translate-x-1/2 group cursor-zoom-in"
